...
test('Month grid is speedy', function() {
    ...
    expect($ms)->toBeLessThan(10.96); // previous 1835.7ms
...
test('Month grid is small', function() {
    ...
    expect($kb)->toBeLessThan(9); // previous 4165kb
})->group('ui', 'month');
