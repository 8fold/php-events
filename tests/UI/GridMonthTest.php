...
// -> forMonth
    ...
    public function render_previous_link()
    {
        ...
        AssertEquals::applyWith(
            ...
            "string",
            6.56, // 5.13, // 2.52, // 1.99, // 1.82, // 1.51, // 1.48, // 1.47, // 1.12,
            1
        )->unfoldUsing(
        ...
        AssertEquals::applyWith(
            ...
            "string",
            8.32, // 6.08, // 5.57, // 5.52, // 4.47, // 4.21, // 3.36, // 3.06,
            18
        )->unfoldUsing(
        ...
        AssertEquals::applyWith(
            ...
            "string",
            15.72, // 15, // 13.53, // 12.68, // 9.63, // 8.03, // 7.79,
            3
        )->unfoldUsing(
    ...
    public function rendered_grid()
    {
        AssertEquals::applyWith(
            ...
            "string",
            1633.05, // 1335.19, // 496.1, // 485.47, // 484.4, // 481.08, // 458.7, // 436.29, // 365.46, // 312.88,
            4165
        )->unfoldUsing(
