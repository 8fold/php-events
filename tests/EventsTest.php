...
class EventsTest extends TestCase
{
    ...
    public function seek_year_with_events()
    {
        ...
        AssertEquals::applyWith(
            2022,
            "string",
            15.31, // 7.34, // 7.24, // 7.11, // 6.41, // 5.36, // 4.7, // 4.1, // 3.63,
            1
        )->unfoldUsing(
    ...
    public function seek_month_with_events()
    {
        AssertEquals::applyWith(
            5,
            "string",
            43.73, // 34.5, // 21.3, // 9.32, // 7.66, // 7.56, // 7.34, // 7.3, // 7.18,
            594 // 496 // 486 // 481
        )->unfoldUsing(
        ...
        AssertEquals::applyWith(
            5,
            "string",
            11.59, // 10.07, // 9.65, // 9.43, // 9.1, // 8.7, // 7.91, // 5.47, // 5.3, // 5.07, // 4.78, // 4.7, // 4.61,
            28
        )->unfoldUsing(
        ...
        AssertEquals::applyWith(
            5,
            "string",
            5.27, // 4.88, // 3.52, // 3.14, // 2.53, // 1.85, // 1.84, // 1.81, // 1.78,
            1
        )->unfoldUsing(
