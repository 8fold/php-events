...
// -> totals for rendering
    ...
    public function testTotalGridItems()
    {
        AssertEquals::applyWith(
            12,
            "integer",
            1.63, // 1.31, // 1.12, // 1.1, // 0.91, // 0.88, // 0.85, // 0.76, // 0.66, // 0.55, // 0.51, // 0.5, // 0.49,
            103 // 98 // 25
        )->unfoldUsing(
...
// -> forMonth
    ...
    public function render_month()
    {
        ...
        AssertEquals::applyWith(
            ...
            "string",
            36.13, // 15.47, // 15.13, // 13.58, // 13.14, // 10.89, // 9.02, // 8.81, // 7.39,
            94 // 30 // 28
        )->unfoldUsing(
        ...
        AssertEquals::applyWith(
            ...
            "string",
            4.88, // 4.23, // 3.48, // 3.17, // 2.09, // 1.73, // 1.48, // 1.09, // 1.08, // 1.06, // 0.99,
            64
        )->unfoldUsing(
