...
// -> forMonth
    public function testRenderMonth()
    {
        ...
        $expected = '<button id="toggle-20200522" class="calendar-date" onclick="efEventsDisplayModal(this, 20200522)"><abbr title="22nd of May 2020">22</abbr><span>Hello, Event!</span><span>Hello, Day?</span></button>';
        $actual = $grid->gridItem(
